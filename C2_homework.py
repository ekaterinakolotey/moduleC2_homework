    ...
    def get_input(self, input_type):
        ...
        if input_type == "shot":
            ...
            if self.is_ai:
                ...
                if user_input == '':
                    self.message.append('Ошибка ввода данных')
                    return 500, 0
...
if __name__ == '__main__':
    ...
    players = []
    players.append(Player(name='Пользователь', is_ai=False))
    players.append(Player(name='Компьютер', is_ai=True))
    game = Game()
    ...
    while True:
        ...
        if game.status == 'in game':
            ...
            if shot_result == 'miss':
                ...
                game.next_player.message.append(f'Ваш ход {game.next_player.name}!')
                game.switch_players()
                continue
                ...
                game.next_player.message.append('Корабль ранен')
                continue
        ...
        if game.status == 'game over':
            ...
            print(f'Это был последний корабль {game.next_player.name}')
